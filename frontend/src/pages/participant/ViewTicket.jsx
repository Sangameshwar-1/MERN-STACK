...
const ViewTicket = () => {
  ...
  return (
    <div className="section animated-fade" style={{ display: 'flex', justifyContent: 'center', alignItems: 'center', minHeight: '60vh' }}>
      <div className="ticket-card" style={{ width: '100%', maxWidth: '400px', padding: '2rem', textAlign: 'center', borderRadius: '16px' }}>
        ...
        <div style={{ marginTop: '2rem' }}>
          ...
          <Link to="/participant" className="btn-ghost" style={{ width: '100%', display: 'block', textAlign: 'center' }}>← Back to Dashboard</Link>
        </div>
      </div>
    </div>
  );
